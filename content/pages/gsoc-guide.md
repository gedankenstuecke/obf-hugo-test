...
- If you want to apply with your own idea, it’s best to [contact](/obf-hugo-test/wp/events/gsoc/gsoc-contact) the OBF subproject you’re interested in well before the application deadline, so we can work with you to find a mentor and solidify your project idea and application.
- [Ask us questions](/obf-hugo-test/wp/events/gsoc/gsoc-contact) on the subproject mailing lists about the project idea you have in mind.
- Write a project proposal draft, include a project plan (see below), and [send it to a project mailing list](/obf-hugo-test/wp/events/gsoc/gsoc-contact) for comments before submitting it.
